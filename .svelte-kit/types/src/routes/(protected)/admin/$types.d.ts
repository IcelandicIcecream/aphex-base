...
type LayoutRouteId = RouteId | "/(protected)/admin" | "/(protected)/admin/organizations" | "/(protected)/admin/settings" | "/(protected)/admin/settings/account" | "/(protected)/admin/settings/api-keys" | "/(protected)/admin/settings/members" | "/(protected)/admin/settings/roles"
