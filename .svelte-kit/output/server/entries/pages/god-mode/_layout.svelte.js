import { Q as attr, c as ensure_array_like, et as escape_html, n as attr_class, p as stringify } from "../../../chunks/dev.js";
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (data.unauthorized) {
			...
			children($$renderer);
			$$renderer.push(`<!----></div></div> <div class="mx-auto mt-auto pt-8"><p class="text-muted-foreground text-center text-xs">Aphex CMS - Built with SvelteKit</p> <div class="mt-2 flex justify-center opacity-20"><svg class="h-8 w-8 fill-black dark:fill-white" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path d="M13.956 3.43635L18.1456 3.43635L20.1641 3.43712C20.1666 3.43712 20.169 3.43842 20.1703 3.44054C20.1715 3.44258 20.1737 3.44386 20.1761 3.44396C22.062 3.5162 23.7574 4.60042 24.6713 6.33551L39.9102 35.267C40.2138 35.8434 39.7924 36.539 39.1397 36.5389L37.0679 36.5386C36.7688 36.5385 36.4919 36.3839 36.3355 36.1298L33.3801 31.3267C33.3173 31.2248 33.234 31.1371 33.1354 31.0693L24.6492 25.2343C23.457 24.4143 22.9948 22.8169 23.5659 21.4933L24.9105 18.3752C25.0235 18.1132 25.0007 17.813 24.8495 17.5726L22.392 13.664C22.0261 13.0821 21.1578 13.1443 20.8721 13.773L17.1504 21.9631C16.9899 22.3162 17.0829 22.7318 17.3781 22.9805L23.2854 27.9596C23.4723 28.1172 23.5518 28.3711 23.488 28.6038C23.2148 29.5985 22.4862 30.3843 21.5288 30.7153L19.6562 31.3627C18.9307 31.6136 18.1203 31.4916 17.4756 31.0346L14.7977 29.1361C14.3844 28.8431 13.807 28.969 13.5495 29.4083L12.1813 31.7429L10.9914 33.8867C10.8996 34.052 10.7565 34.1831 10.5839 34.26L5.47512 36.5347C4.73679 36.8634 3.99524 36.0938 4.35059 35.3675L15.9857 11.5884C16.2933 10.9599 15.7701 10.2485 15.08 10.3567L5.31911 11.8868C4.98066 11.9398 4.64386 11.7884 4.46008 11.5005L0.164217 4.77114C-0.203334 4.19538 0.213947 3.43746 0.898521 3.43741L13.956 3.43635Z"></path></svg></div></div></div>`);
		}
		$$renderer.push(`<!--]-->`);
	});
}
